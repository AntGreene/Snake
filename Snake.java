...
public class Snake extends Application {
    ...
    private void showStarterPage(Stage primaryStage) {
        GridPane gp = new GridPane();
        VBox.setVgrow(gp, javafx.scene.layout.Priority.ALWAYS);
